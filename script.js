...
function buttonClickYes() {
    if (question.textContent == "واش تعلمتي شي حاجة اليوم؟") {
        ...
        question.textContent = "هنا تقدر تبدا تكتب أفكارك وتنظمها";
    ...
    } else if (question.textContent == "يمكن ليك تبدا بكتاب" || 
        question.textContent == "هنا تقدر تبدا تكتب أفكارك وتنظمها" ||
        question.textContent ==  "واش فراسك 66% ديال المتمدرسين فالمغرب مكيعرفو لا يفهمو لا يكتبو نص بسيط بأي لغة كان. حتال إمتا أنبقاو هاكا؟" ||
